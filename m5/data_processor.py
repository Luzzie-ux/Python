...
class NPE(DPE):
    def __init__(self, message="Unknown Numeric Processor Error") -> None:
        super().__init__(message)


# Textual Processor Exception
class TPE(DPE):
    def __init__(self, message="Unknown Text Processor Error") -> None:
        super().__init__(message)


# Logical Processor Exception
class LPE(DPE):
    def __init__(self, message="Unknown Logical Processor Error") -> None:
        super().__init__(message)
